...
class CourseWithLessons {
  ...
  factory CourseWithLessons.fromJson(Map<String, dynamic> json) => CourseWithLessons(
    ...
    soldNumber: json["soldNumber"].toInt(),
    ratedNumber: json["ratedNumber"].toInt(),
    videoNumber: json["videoNumber"].toInt(),
...
class Section {
  ...
  factory Section.fromJson(Map<String, dynamic> json) => Section(
    ...
    numberOrder: json["numberOrder"].toInt(),
    name: json["name"],
...
class Lesson {
  ...
  factory Lesson.fromJson(Map<String, dynamic> json) => Lesson(
    ...
    videoName: json["videoName"] == null ? 'no data' : json["videoName"] as String,
