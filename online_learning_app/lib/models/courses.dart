...
class Payload {
  ...
  factory Payload.fromJson(Map<String, dynamic> json) => Payload(
    ...
    soldNumber: json["soldNumber"] == null ? 0.0 : json['soldNumber'].toDouble(),
    ratedNumber: json["ratedNumber"] == null ? 0.0 : json['ratedNumber'].toDouble(),
    videoNumber: json["videoNumber"] == null ? 0.0 : json['videoNumber'].toDouble(),
    totalHours: json["totalHours"] == null ? 0.0 : json['totalHours'].toDouble(),
    formalityPoint: json["formalityPoint"] == null ? 0.0 : json['formalityPoint'].toDouble(),
    contentPoint: json["contentPoint"] == null ? 0.0 : json['contentPoint'].toDouble(),
    presentationPoint: json["presentationPoint"] == null ? 0.0 : json['presentationPoint'].toDouble(),
